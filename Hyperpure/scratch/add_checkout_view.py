# add_checkout_view.py
# Register CheckoutView.swift in project.pbxproj
...
f_info = {
    ...
    "path": "Hyperpure/Views/Cart/CheckoutView.swift",
...
if "CheckoutView.swift" in content:
...
print("Registered CheckoutView.swift successfully")
