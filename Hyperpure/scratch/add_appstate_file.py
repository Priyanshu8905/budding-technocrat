# add_appstate_file.py
# Register AppState.swift in project.pbxproj
...
f_info = {
    "name": "AppState.swift",
    "path": "Hyperpure/Models/AppState.swift",
...
print("Registered AppState.swift successfully")
