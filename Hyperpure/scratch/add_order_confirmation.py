# add_order_confirmation.py
# Register OrderConfirmationView.swift in project.pbxproj
...
f_info = {
    "name": "OrderConfirmationView.swift",
    "path": "Hyperpure/Views/Cart/OrderConfirmationView.swift",
...
if "OrderConfirmationView.swift" in content:
...
print("Registered OrderConfirmationView.swift successfully")
