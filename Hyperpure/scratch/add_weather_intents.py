# add_weather_intents.py
# Register WeatherIntelligenceAppIntents.swift in project.pbxproj
...
if "WeatherIntelligenceAppIntents.swift" in content:
...
print("Registered WeatherIntelligenceAppIntents.swift successfully")
