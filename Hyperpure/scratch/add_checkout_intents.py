# add_checkout_intents.py
# Register CheckoutWorkflowIntents.swift in project.pbxproj
...
f_info = {
    "name": "CheckoutWorkflowIntents.swift",
    "path": "Hyperpure/AppIntents/CheckoutWorkflowIntents.swift",
...
if "CheckoutWorkflowIntents.swift" in content:
...
print("Registered CheckoutWorkflowIntents.swift successfully")
