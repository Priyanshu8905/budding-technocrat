# add_widget.py
# Register WeatherIntelligenceWidget.swift in project.pbxproj
...
if "WeatherIntelligenceWidget.swift" in content:
...
print("Registered WeatherIntelligenceWidget.swift successfully")
